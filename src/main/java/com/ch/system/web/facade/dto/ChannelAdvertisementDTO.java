 ...
 * Time: 下午1:48
 */
public class ChannelAdvertisementDTO implements Serializable {
    ...
    public ChannelAdvertisementDTO() {
    }

    public ChannelAdvertisementDTO(int id, int sequence, String advertisementTitle,
