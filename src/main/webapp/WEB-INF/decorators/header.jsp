...
<div class="header">
    ...
    <div class="menu">
        ...
        <a href="${pageContext.request.contextPath}/backend/moduleadvertisementoverview.html" <c:if test="${'AD' eq BROSWER_LOCATION}">style="font-weight:bold;background:#5d5c5c;"</c:if>>广告管理</a>
