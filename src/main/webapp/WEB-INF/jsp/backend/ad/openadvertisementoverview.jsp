    ...
    <tr>
        ...
        <td valign="top">
            <div style="float: left; padding-right: 5px; padding-top: 5px; padding-left: 5px;">
                <a href="#" onclick="window.location.href='${pageContext.request.contextPath}/backend/openadvertisementform.html'"><button class="thoughtbot">添加开机广告</button></a>
            </div>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="list">
                ...
                <c:forEach items="${ads}" var="ad">
                    ...
                    <c:set var="turns" value="${!turns}"/>
                        ...
                        <td>
                            <a href="#" onclick="window.location.href='${pageContext.request.contextPath}/backend/openadvertisementform.html?openAdvertisementId=${ad.id}&current=${current}'"><button class="thoughtbot">编辑</button></a>
