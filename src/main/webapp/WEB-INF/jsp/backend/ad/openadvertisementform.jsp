...
<table cellpadding="0" cellspacing="0" width="100%" class="box">
    <tr>
        ...
        <td valign="top">
            <spring-form:form id="openAdvertisementForm" commandName="openAdvertisement" method="POST" cssClass="form" enctype="multipart/form-data">
                <table cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="thoughtbotform" onclick="window.location.href='${pageContext.request.contextPath}/backend/openadvertisementoverview.html?current=${current}'">
                                返回
                            </button>
