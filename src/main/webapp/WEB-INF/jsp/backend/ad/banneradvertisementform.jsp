...
<table cellpadding="0" cellspacing="0" width="100%" class="box">
  <tr>
    ...
    <td valign="top">
      <spring-form:form id="bannerAdvertisementForm" commandName="bannerAdvertisement" method="POST" cssClass="form" enctype="multipart/form-data">
        <table cellspacing="0" width="100%">
          ...
          <tr valign="top">
            <td width="200px;">
              Banner广告描述 <span class="required">*</span>
            </td>
            <td>
          ...
          <tr valign="top">
            <td width="200px;">
              Banner广告对应频道 <span class="required">*</span>
            </td>

            <td>
              <spring-form:input id="serviceId" path="serviceId"  maxlength="100" cssStyle="width:300px;"/>&nbsp;
          ...
          <tr valign="top">
            <td width="200px;" valign="top">
              选择Banenr广告图片 <span class="required">*</span><br/>(支持PNG, JEPG, JPG, BMP格式上传)
            </td>
            <td>
              ...
              <c:if test="${openAdvertisement.advertisementFileId > 0}">
                ...
                <br/>
                <br/>
                <img src="${applicationWebAddress}${openAdvertisement.advertisementActualFileName}" style="width: 600px;" />
              </c:if>
          ...
          <tr>
            ...
            <td>
              <button type="button" class="thoughtbotform" onclick="window.location.href='${pageContext.request.contextPath}/backend/banneradvertisementoverview.html?current=${current}'">
                返回
              </button>
              <button name="" type="button" class="thoughtbotform" onclick="submitOpenAdvertisementForm(this.form)">保存</button>
            </td>
          </tr>
        </table>
      </spring-form:form>
