...
<table cellpadding="0" cellspacing="0" width="100%" class="box">
    <tr>
        ...
        <td valign="top">
            <spring-form:form id="channelAdvertisementForm" commandName="channelAdvertisement" method="POST" cssClass="form" enctype="multipart/form-data">
                <table cellspacing="0" width="100%">
                    <input type="hidden" name="id" value="${channelAdvertisement.id}"/>
                    <input type="hidden" name="advertisementFileId" value="${channelAdvertisement.advertisementFileId}"/>

                    <tr>
                        <td width="200px;">
                             频道列表广告描述 <span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td width="200px;" valign="top">
                             选择频道列表广告图片 <span class="required">*</span><br/>(支持PNG, JEPG, JPG, BMP格式上传)
                        </td>
                        <td>
                            <input type="file" id="advertisementFile" name="advertisementFile" class="file" style="width:300px;"/>
                            <c:if test="${channelAdvertisement.advertisementFileId > 0}">
                                <br/>
                                <br/>
                                已上传文件:${channelAdvertisement.advertisementUploadFileName}
                                <br/>
                                <br/>
                                <img src="${applicationWebAddress}${channelAdvertisement.advertisementActualFileName}" style="width: 600px;" />
                            </c:if>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="thoughtbotform" onclick="window.location.href='${pageContext.request.contextPath}/backend/channeladvertisementoverview.html?current=${current}'">
                                返回
                            </button>
                        	<button name="" type="button" class="thoughtbotform" onclick="submitChannelAdvertisementForm(this.form)">保存</button>
                        </td>
                    </tr>
                </table>
            </spring-form:form>
...
<script type="text/javascript">
    function submitChannelAdvertisementForm(form) {
